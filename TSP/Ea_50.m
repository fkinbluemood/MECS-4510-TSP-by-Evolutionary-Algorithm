    ...
    for k =1: runs
        ...
        %num(n,:)=randperm(1000,1000);
            ...
            for j=1:evl
                ...
                elseif k_point==3
                [priorities_of_cities(population_size/2 + 1 :population_size,:)] = cross_over_and_recombined_mutate_cross_3p(priorities_of_cities(population_size/2 + 1 :population_size,:), k_point);
                end
